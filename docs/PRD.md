...
- **上帝视角**: 所有的复杂逻辑隐藏在后台，GM 只看结果与进度。
- **隐私保护**: 财务与薪酬数据默认高斯模糊，隐私是移动端办公的第一优先级。
- **20px 轴心**: 极致的秩序感，所有列表、时间轴与轴线像素级对齐。

## 3. 需求优先级矩阵 (Prioritization)

| 优先级 | 功能范畴 | 关键点 |
| :--- | :--- | :--- |
| **P0 (高)** | **核心决策闭环** | 经营盈亏看板、AI 风险诊断、交付进度时间轴、增减员动态(含办理日期/预计日期) |
| **P1 (中)** | **业务穿透能力** | 入职办理、个人薪资明细穿透(应发/扣除/实发)、资金流水解释、发票管理 |
...
- [入职办理流程](./requirements/inbox/onboarding_process.md)

### 4.3 事务工作台 (Workstation)
- [03_Workstation.md](./requirements/03_Workstation.md)
- [财务明细 (对账中心/流水/发票/报销/凭证)](./requirements/workstation/)
- [人事明细 (个人薪酬穿透/员工档案/增减员动态看板/合同)](./requirements/workstation/)
