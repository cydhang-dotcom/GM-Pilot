...
import { Building2, ChevronRight, ShieldCheck, Stamp, Users, FileText, Landmark, Repeat, Eye, EyeOff, ArrowDownLeft, ArrowUpRight, Copy, History, Bell, MapPin, ScrollText, User } from 'lucide-react';
...
const Company: React.FC = () => {
  ...
  const menuGroups = [
    ...
    { title: '企业管理与权益', items: [
      { id: 'seal', icon: Stamp, label: '电子印章', value: '3枚', iconTheme: 'text-rose-500' }, 
      { id: 'cert', icon: ShieldCheck, label: '数字权鉴', value: '3项授权', iconTheme: 'text-emerald-500' }, 
      { id: 'contract', icon: ScrollText, label: '签约服务', value: '尊享版', iconTheme: 'text-purple-500' },
      { id: 'admin', icon: Users, label: '成员权限', value: '2人', iconTheme: 'text-slate-500' }, 
      { id: 'log', icon: History, label: '操作日志', value: '', iconTheme: 'text-slate-500' }, 
      { id: 'notify', icon: Bell, label: '消息通知', value: '已开启', iconTheme: 'text-slate-500' },
      { id: 'account', icon: User, label: '我的账号', value: '', iconTheme: 'text-indigo-500' }
    ] }
  ];
